                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-6 col-lg-4 order-sm-2 order-xl-2">
                          <div class="row">
                            <div class="col-md-6">
                              <div class="ttl-info text-start">
                                <h6><i class="fa fa-phone"></i> Contact Us</h6><span><?= $user['telp'];?></span>
                              </div>
                            </div>
                            <div class="col-md-6">
                              <div class="ttl-info text-start">
                                <h6><i class="fa fa-location-arrow"></i>Location</h6><span><?= $user['name_cabang'];?></span>
                              </div>
                            </div>
                          </div>
                        </div>
                                ...
                                <a href="<?= base_url('admin/user'); ?>" class="btn btn-primary" type="submit">Back</a>
                      </div>
                    </div>
                  </div>
