                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                      <li class="nav-item"><a class="nav-link active" id="home-tab" data-bs-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">Draft</a></li>
                      <li class="nav-item"><a class="nav-link" id="profile-tabs" data-bs-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">Diterima</a></li>
                      <li class="nav-item"><a class="nav-link" id="contact-tab" data-bs-toggle="tab" href="#contact" role="tab" aria-controls="contact" aria-selected="false">Direvisi</a></li>
                    </ul>
                    
                    <br><br>
                      <!-- Tambah Data -->
                      <a href="<?= base_url('admin/tambahSuratmasuk'); ?>" class="btn btn-outline-primary"
                        type="button" data-original-title="btn btn-outline-danger-2x" style="width: 250px;">Tambah
                        Data</a>
                    <!-- End Tambah Data -->
                                    ...
                                    <table class="display" id="basic-2" style="text-align:center;">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <!-- edit -->
                                                        <a href="<?= base_url(); ?>admin/editsurat/<?= $draft['id_surat']; ?>"
